<template>
   <div id="detail" class="slide">
       <HeaderVue title="影片详情">
               <i class="iconfont icon-right" @touchstart="handleToBack"></i>
       </HeaderVue>
       <Loading v-if="isLoading"></Loading>
       <div v-else id="content" class="contentDetail">
           <div class="detail_list">
               <div class="detail_list_bg" :style="{backgroundImage:'url(' + detailList.img.replace(/w\.h/,'148.208') + ')'}"></div>
           ...
           <div class="detail_player swiper-container" ref="detail_player">
               <ul class="swiper-wrapper">
                   <li class="swiper-slide" v-for="(item,index) in detailList.photos" :key="index">
                       <div>
                           <img :src=" item| setWH('140.100')" alt="">
                       </div>
                      <!-- <p>陈建斌</p>
                       <p>马先勇</p>-->
                   </li>
...
<style scoped>
    #detail{position: absolute; left: 0; top: 0; z-index: 100; width: 100%; min-height: 100%; background: #fff;}
    #detail.slide{animation:.3s slideMove;}
    @keyframes slideMove{
